...
public enum CategoriesHierarchy {
  ...
  public static class Category {
    ...
    @Override public int hashCode() {
      return 1 * 31 + (name == null ? 0 : name.hashCode());
    }
  ...
  public static class Hierarchy {
    ...
    public static boolean addCategory(final Category c) {
      return inner.addVertex(c);
    }
    ...
    public static void addKeywordCategory(final Category c) {
      c.isKeyword = true;
      inner.addVertex(c);
    }
    public static void addTriviaCategory(final Category c) {
      c.isTrivia = true;
      inner.addVertex(c);
    }
    public static boolean isClassifiedAs(final Category c, final Category classification) {
      ...
      for (final Edge e : set)
        if (inner.getEdgeTarget(e).equals(classification) || isClassifiedAs(inner.getEdgeTarget(e), classification))
          return true;
      return false;
    }
    ...
    public Category getEdgeSource(final Edge e) {
      return inner.getEdgeSource(e);
    }
    public Category getEdgeTarget(final Edge e) {
      return inner.getEdgeTarget(e);
    }
    public double getEdgeWeight(final Edge e) {
      return inner.getEdgeWeight(e);
    }
    @Override public int hashCode() {
    ...
    public boolean removeAllEdges(final Collection<? extends Edge> es) {
      return inner.removeAllEdges(es);
    }
    ...
    public boolean removeEdge(final Edge e) {
      return inner.removeEdge(e);
    }
    public boolean removeVertex(final Category v) {
      return inner.removeVertex(v);
    }
    public void setEdgeSetFactory(final EdgeSetFactory<Category, Edge> edgeSetFactory) {
      inner.setEdgeSetFactory(edgeSetFactory);
    }
