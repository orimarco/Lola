...
public abstract class Keyword extends Builder {
  ...
  protected ArrayList<String> expectedElaborators = new ArrayList<>(Arrays.asList(new String[] {}));
  public SnippetToken snippet = null;
  ...
  @Override public List<Elaborator> elaborators() {
    return elaborators;
  }
  @Override public List<Node> list() {
    return list;
  }
  // default mature
  ...
  @Override public SnippetToken snippet() {
    return snippet;
  }
}
