...
public class TokenizerTest {
  ...
  @Test public void test3() throws IOException, ParseException {
  ...
  @Test public void testEnterN() throws IOException {
  ...
  @Test public void testEnterR() throws IOException {
  ...
  @Test public void testEnterRNN() throws IOException {
    final Reader stream = new StringReader("x\r\n\nz");
    tokenizer = new Tokenizer(stream);
    Token token = tokenizer.next_token();
    assertEquals("x", token.text);
  ...
  @Test public void testImportExpression() throws IOException {
