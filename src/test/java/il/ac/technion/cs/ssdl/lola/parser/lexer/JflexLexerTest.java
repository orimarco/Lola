...
public class JflexLexerTest {
  ...
  @Test public void test$If() throws IOException, ParseException {
  ...
  @Test public void test$Include() throws IOException, ParseException {
  ...
  @Test public void testAssignment() throws IOException, ParseException {
  ...
  @Test public void testImportSnippet() throws IOException {
    final Reader stream = new StringReader("##Import java.il.omg");
    jfl = new JflexLexer(stream);
    assertEquals("##Import", ((Token) jfl.next_token()).text);
  }
  @Test public void testNumbersClassifiedAsLiterals() throws IOException, ParseException {
  ...
  @Test public void testSignsAndHostNotClassifiedAsLiteral() throws IOException, ParseException {
  ...
  @Test public void testStringLiteralsClassifiedAsLiteral() throws IOException, ParseException {
  ...
  @Test public void testTabulation() throws IOException, ParseException {
  ...
  @Test public void testTriviaNotClassifiedAsLiteral() throws IOException, ParseException {
    Reader stream = new StringReader("\n");
    jfl = new JflexLexer(stream);
    Token token = (Token) jfl.next_token();
    assertEquals(false, CategoriesHierarchy.isClassifiedAs(token.category.name, "literal"));
  ...
  @Test public void testTriviaseparation() throws IOException, ParseException {
    final Reader stream = new StringReader("\"omg\" ");
    jfl = new JflexLexer(stream);
    final Token token = (Token) jfl.next_token();
    assertEquals("lstring", token.category.name);
    assertEquals("\"omg\"", token.text);
  }
  @Test public void testUserDefinedKeyword() throws IOException {
    final Reader stream = new StringReader("##Omg");
    jfl = new JflexLexer(stream);
